...
<br /><br /><br /><br /><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066">Kayıt Formu</font></center><hr size="1" />
<form id="form1" method="post" action="<?php echo $_SERVER["SCRIPT_NAME"] ?>">
  <table width="939" height="76" border="0" align="center">
	...
	<br /><br /><center><input type="reset" value="Vazgeç"> <input name="kayit_ol" type="submit" id="kayit_ol" value="Kayıt Ol">
	</center>
	</td>
      <td width="31">&nbsp;</td>
    </tr>
