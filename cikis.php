...
<?php
@session_start();
//Oturum açtığımız değişkenimiz olan admini siliyoruz.
unset($_SESSION['kullanici']);
//Daha sonra mevcut oturumumuzu siliyoruz.
session_destroy();
//Ve çıkışımız tamamlandığı için tekrar ana giriş sayfasına yönlendiriyoruz.
