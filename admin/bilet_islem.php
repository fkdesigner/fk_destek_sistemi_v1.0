...
echo "<br><br><center><font face='verdana' size='2' color='red'><b>Bu şekilde bir kullanım söz konusu olamaz.</b></font><br><br><a href='admin.php'>Admin Sayfasına Dön.</a></center>";
exit;
}
...
echo '<a href="admin.php?sayfa=destek_biletleri">Geri Dön</a></b></center>';
exit;
}
else {
...
echo '<center><a href="admin.php?sayfa=destek_biletleri">GERİ</a></center>';
...
if (isset($_POST["cevapla"])) {
	...
	//Veritabanından kullanıcının mail adresini çekiyoruz.
	...
	//Kullanıcıya mail atıyoruz.
	//Üyemize mail atarak biletine cevap verildiğini kendisine bildiriyoruz.
	...
	$son_mesaj .= '<font face="verdana" size="2" color="black"><p>Sayın '."$kullanici_adi".', açmış olduğunuz destek biletlerinden birine cevap verildi ve biletiniz kapatıldı. Lütfen şu adresten kontrol edin:'.'<a href="'."$bilet_sayfasi".'">'."$bilet_sayfasi".'</a>'.'</p><p>'."$site_adi".' Yönetimi</font>';
	$son_mesaj .= '<br><br><font face="verdana" size="1" color="black">Bu e-mail <b><font face="verdana" size="1" color="red">FK</font> <font face="verdana" size="1" color="blue">Designer</font> Geliştirici Takımı</b>nin <font face="verdana" size="1" color="blue">FK Destek Sistemi</font> üzerinden gönderilmiştir.</font><br><br>';
	$son_konu = "Biletiniz Cevaplandı";
	...
	#Cevaplanırsa bilet durumu kapalı olacak, kullanıcıya mail gidecek, cevap veritabanına kaydedilecek.
...
//Sonuç
if ($bilet_ac){
echo "<br><center><font face='verdana' size='2' color='green'><b>Bilet açıldı.</b></font><br><br><a href='admin.php?sayfa=destek_biletleri&goster=cevaplanmis'>Geri Dön</a></center>";
}
else {
echo "<br><center><font face='verdana' size='2' color='red'><b>Bir sorun oluştu ve bilet açılamadı.</b></font><br><br><a href='admin.php?sayfa=destek_biletleri&goster=cevaplanmis'>Geri Dön</a></center>";
}
...
//Sonuç
if ($bilet_kapat){
echo "<br><center><font face='verdana' size='2' color='green'><b>Bilet kapatıldı.</b></font><br><br><a href='admin.php?sayfa=destek_biletleri&goster=bekleyen'>Geri Dön</a></center>";
}
else {
echo "<br><center><font face='verdana' size='2' color='red'><b>Bir sorun oluştu ve bilet kapatılamadı.</b></font><br><br><a href='admin.php?sayfa=destek_biletleri&goster=bekleyen'>Geri Dön</a></center>";
}
//Eğer kapat butonuna basılmış ise yapılacak işlemlerin sonu aşağıdaki satır kapatıcı kod içerir.
}


//EĞER SİLE BASILMIŞ İSE AŞAĞIDAKİ İŞLEMLER YAPILACAKTIR.
if (isset($_POST["sil"])) {
//Şimdi veritabanımızdan biletimizi siliyoruz, eğer varsa bilete dair yazışmaları da siliyoruz.
...
if ($bilet_sil){
echo '<br><center><b><font face="verdana" size="2" color="green">Bilet silindi.</font><br><br><a href="admin.php?sayfa=destek_biletleri">Geri Dön</a>';
}
else {
echo '<br><center><b><font face="verdana" size="2" color="red">Bir sorun oluştu ve bilet silinemedi. Lütfen tekrar deneyin.</font><br><br>';
echo '<a href="admin.php?sayfa=destek_biletleri">Geri Dön</a></b></center>';
exit;
}
//Eğer sil butonuna basılmış ise yapılacak işlemlerin sonu aşağıdaki satır kapatıcı kod içerir.
}
