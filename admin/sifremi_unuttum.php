...
//Mail ile atılacak değişkenler şöyle: $admin_email ve $sifre;
...
$son_mesaj .= '<font face="verdana" size="2" color="black"><p>Sayın '."$admin_username".', şifrenizi unuttuğunuza ve yeni bir tane talep ettiğinize dair bir bildirim aldık. Kendinize şu adresten yeni bir şifre belirleyebilirsiniz:'."$yeni_sifre_linki".'</p><p>Eğer böyle bir talepte bulunmadıysanız bu e-maili önemsemeyin ve mevcut şifrenizi kullanmaya devam edin. Teşekkürler.</p><p>'."$site_adi".' Yönetimi</font>';
  ...
  <tr>
	...
	<form id="form1" method="post" action="<?php echo $_SERVER["SCRIPT_NAME"] ?>">
                      <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="grey">Şifreniz e-posta adresinize gönderilecektir.</font><br /><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000066">E-Posta Adresiniz : </font>
                        ...
                        <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000066">Güvenlik Kodu : </font>
