...
?>
<b><font face="verdana" size="3" color="#FF0000">DESTEK BİLETLERİM</font></b>
<br /><br />
<?php
//Kullanıcının panelde gezineceği sayfaları ayarlıyoruz, böylece linkler sayesinde panele farklı sayfalar yüklenecek
@$goster = $_GET['goster'];
switch ($_GET['goster']){
    case 'bekleyen':
	...
	default:
	?>
	<center><font face="verdana" size="2" color="#0033CC"><a href="<?php echo $sayfa.'&goster=bekleyen' ?>">Bekleyen Destek Biletlerim</a> (<?php echo $acik_bilet_sayac_sonucu; ?>) | <a href="<?php echo $sayfa.'&goster=cevaplanmis' ?>">Cevaplanmış Destek Biletlerim</a> (<?php echo $kapali_bilet_sayac_sonucu; ?>)</font></center>
    <?php
